!function(modules){function __webpack_require__(moduleId){if(installedModules[moduleId])return installedModules[moduleId].exports;var module=installedModules[moduleId]={exports:{},id:moduleId,loaded:!1};return modules[moduleId].call(module.exports,module,module.exports,__webpack_require__),module.loaded=!0,module.exports}var installedModules={};return __webpack_require__.m=modules,__webpack_require__.c=installedModules,__webpack_require__.p="",__webpack_require__(0)}([function(module,exports,__webpack_require__){"use strict";var $=__webpack_require__(1);$(document).ready(function(){var app={init:function(){this.cacheDom(),this.bindEvents()},cacheDom:function(){this.$form=$("#form"),this.$search=$("#search"),this.$links=$("#links")},bindEvents:function(){this.$form.submit(this.renderData)},renderData:function(){var searchInput=app.$search.val(),url="https://en.wikipedia.org/w/api.php?action=opensearch&search="+searchInput+"&format=json&callback=wikiCallback";return app.$links.html(""),app.$search.val(""),$.ajax({url:url,dataType:"jsonp",type:"POST",success:function(data){for(var i=0;i<data[1].length;i++){var title=data[1][i],summary=data[2][i],link=data[3][i];app.$links.append('<li><strong><a href="'+link+'" target="_blank">'+title+"</strong><p>"+summary+"</p></a></li>")}}}),!1}};app.init()})},function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;/*!
